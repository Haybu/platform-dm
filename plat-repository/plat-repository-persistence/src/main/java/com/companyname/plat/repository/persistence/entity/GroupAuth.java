 ...
 */
@Entity
@Table(name = "app_group_auth")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "GroupAuth.findAll", query = "SELECT a FROM GroupAuth a"),
    @NamedQuery(name = "GroupAuth.findById", query = "SELECT a FROM GroupAuth a WHERE a.id = :id")})
public class GroupAuth implements Serializable {
    ...
    public String toString() {
        return "com.companyname.plat.repository.persistence.entity.AppGroupAuth[ id=" + id + " ]";
    }
